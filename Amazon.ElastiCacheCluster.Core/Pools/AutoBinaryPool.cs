...
namespace Amazon.ElastiCacheCluster.Core.Pools
{
    internal class AutoBinaryPool : AutoServerPool
    {
        ...
        protected override IMemcachedNode CreateNode(EndPoint endpoint, ILogger logger)
        {
            if (endpoint == null)
                throw new ArgumentNullException("endpoint");
            return new BinaryNode(endpoint, this.configuration.SocketPool, this.authenticationProvider, logger);
        }
